...
\change[inline]{TODO: Add minimality from Lecture-9.pdf (purdue.edu) or Simplifying and isolating failure-inducing input - Software Engineering, IEEE Transactions on (columbia.edu)}
...
\change[inline]{TODO: Add the algorithm from Lecture-9.pdf (purdue.edu)}
...
\change[inline]{TODO: Give definitions for the criterion and the slice.}
...
\change[inline]{TODO: Illustrate static slicing on a SLIGHTLY branching code.}
...
\change[inline]{TODO: Illustrate dynamic slicing on a branching code.}
...
\change[inline]{TODO: Add the criterion definition from Silva}
