...
\change[inline]{TODO: Add a reference to the algorithm in text, so that reader knows what it is.}
...
\change[inline]{TODO: Mention forward and backward slicing.}
...
\change[inline]{TODO: Rename code snippets to "listings", use different package.}
\change[inline]{TODO: Fix the vertical centering.}
...
\change[inline]{TODO: Correct the PDG slicing figure and add a footnote.}
