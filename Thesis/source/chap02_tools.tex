...
\begin{figure}[t]
\includegraphics[scale=0.35]{gcc_ast}
\centering
\caption{GCC AST Dump}
This figure showcases the AST representation of Algorithm~\ref{alg:simple}
as dumped by GCC.
Note that it is not easily comprehendable.
\end{figure}
