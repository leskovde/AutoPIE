...
\begin{tabular}{rSrSSS} \toprule
    ...
    10 & {$2^{62}$} & 2949 & 2.405 & 44.689 & 0.0s  \\ \midrule
    11 & {$2^{31}$} & 245 & 3.661 & 23.536 & 0.0s  \\
    ...
    20 & {$2^{24}$} & 38 & 0.0 & 53.403 & 0.0s  \\ \midrule
    21 & {$2^{41}$} & 592 & 28.755 & 55.043 & 0.0s  \\
...
\begin{tabular}{rSrSSS} \toprule
    ...
    10 & {$2^{62}$} & 52 & 34.268 & 76.553 & 0.0s  \\ \midrule
    11 & {$2^{31}$} & 92 & 29.497 & 49.373 & 0.0s  \\
    ...
    20 & {$2^{24}$} & 60 & 0.0 & 41.734 & 0.0s  \\ \midrule
    21 & {$2^{41}$} & 87 & 15.450 & 80.790 & 0.0s  \\
