...
Table~\ref{tab:astcontext} contains a digest of \icode{ASTContext}'s Doxygen 
documentation. 
...
The summary only shows members relevant for this project.
...
In the example shown in Figure~\ref{lst:astconsumer}, the consumer passes 
...
the \icode{RecursiveASTVisitor} class.
