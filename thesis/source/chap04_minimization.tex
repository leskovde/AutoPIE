...
Algorithm~\ref{alg:naive} describes the naive process. 
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State $variantQueue.Push(input)$
		\Comment Where $input$ is algorithm's input.
...
\begin{algorithm}
	...
	\hspace*{\algorithmicindent}\hspace*{\algorithmicindent} $L \ldots$ location of the error. \\
	\hspace*{\algorithmicindent}\hspace*{\algorithmicindent} $P \ldots$ the input source code. \\
	\hspace*{\algorithmicindent}\hspace*{\algorithmicindent} $A \ldots$ the input program's arguments. \\
	\hspace*{\algorithmicindent} \textbf{Output:} The reduced source code. 
	\begin{algorithmic}[1]
...
The proposed systematical solution is described in~\ref{alg:slicing}.
