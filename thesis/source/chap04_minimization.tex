...
\change[inline]{TODO: Create an example of \icode{if (...)\{\} else(...)\{\}} and their bodies.} 
...
the \icode{if(...)} statement depends on the \icode{if(...)} statement. 
...
$\{v_1, v_2, \ldots, v_k\}$. 
\change[inline]{TODO: Add an example of the removed decl reference.}
...
\begin{enumerate}
  ...
  \item The local minimum can be optimized to the minimal variant by running 
  the naive reduction.
\end{enumerate}
...
\change[inline]{TODO: Add pseudocode explaining the steps of verification.}
