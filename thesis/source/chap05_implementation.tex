...
Su [ref] handles the minimization using an AST. 
...
Section [ref (previous)], we chose to implement a modified version of 
the minimizing Delta algorithm. 
...
\begin{enumerate}
  ...
  The validation uses the module described in Section [ref].
\end{enumerate}
...
The algorithm's main loop is inside the programs' \icode{main} function. 
...
\emph{DeltaReduction/include/Consumers.h}, 
\emph{DeltaReduction/include/Actions.h}, 
\emph{DeltaReduction/src/Actions.cpp}, and \emph{Common/include/Context.h}.
